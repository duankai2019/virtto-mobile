<template>
 <div class="hbl-fa">
   ...
   <div v-for="(item,index) in commentList" :key='index' class="hbl-child">
     ...
     <div class="children" v-for="(ritem,index) in item.childrenList" :key="index">
       <div class="reply"></div>
       <div class="content">
         <div class="comment-f">
...
export default {
  ...
  mounted:function(){
    this.loadComment()
    this.loadCommentBytargetUser()
  },
  methods: {
    loadCommentBytargetUser () {
      console.log("id="+this.$route.params.id)
      var _this = this
      this.$axios.post('/listByfindtargetuser', {id: this.$route.params.id}).then(resp => {
